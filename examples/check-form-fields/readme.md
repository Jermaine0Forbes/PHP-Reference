...
This simple example just check if the form fields are valid or if they have been
filled. If they are not, when you submit the form there will be a list of things
that tell them to fill out.
